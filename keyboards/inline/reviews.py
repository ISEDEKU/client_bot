...
button_1 = InlineKeyboardButton(text='Отзовы в Google', url=BUTTON_1)
reviews_keyboard.insert(button_1)

BUTTON_2 = 'https://www.facebook.com/apparatgps/reviews/'
button_2 = InlineKeyboardButton(text='Отзовы на Facebook', url=BUTTON_2)
reviews_keyboard.insert(button_2)